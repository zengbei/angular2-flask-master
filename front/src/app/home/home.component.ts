...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  public heroes = [];
  private isSaleCollapsed = false;
  private isProjectCollapsed = false;
  private isFinanceCollapsed = false;
  private isDataCollapsed = false;
  private isAdminCollapsed = false;
  private  isReportsCollapsed = false;
